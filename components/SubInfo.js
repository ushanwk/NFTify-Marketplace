...
export const EndDate = () => {
    return(
       <View style={{ paddingHorizontal: SIZES.font, paddingVertical: SIZES.base, backgroundColor: COLORS.white, justifyContent: "center", borderRadius: SIZES.font, alignItems: "center", ...SHADOWS.light, elevation: 1, maxWidth: "50%" }}>
