...
import { SubInfo, EndDate, EthPrice, NFTTitle } from "./SubInfo";
...
const NFTCard = ({ data }) => {
    ...
    return(
        <View style={{ backgroundColor: COLORS.white, borderRadius: SIZES.font, marginBottom: SIZES.extraLarge, margin: SIZES.base, ...SHADOWS.dark }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginHorizontal: SIZES.small, marginBottom: SIZES.small }}>
